...
#自定义连接函数，用于实现L_{k-1}到C_k的连接（频繁项集到候选项集的连接）
...
inputfile = '../data/TransactionTable.xlsx'     #导入文件
outputfile = '../result/TransactionTableReult.xlsx' #结果文件
data = pd.read_excel(inputfile, header = None)      #用pd.read_excel()函数读入数据，header表示没有列名
